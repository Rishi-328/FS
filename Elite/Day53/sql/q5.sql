...
select OrderID,c.CustomerID,OrderDate,TotalCost, Status
from Customers c
join Orders o on o.CustomerID = c.CustomerID
where TotalCost > any (select sum(TotalCost) from Orders where CustomerID<>c.CustomerID group by CustomerID)
